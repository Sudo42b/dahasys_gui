...
Plans:
- [x] 05-01-PLAN.md — Consolidate safe_get closures + fallback port lists + inline imports
- [x] 05-02-PLAN.md — Deduplicate stop-and-save + centralize unit conversion + configparser INI
